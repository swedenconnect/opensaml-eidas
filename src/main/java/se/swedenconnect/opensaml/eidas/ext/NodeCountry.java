...
public interface NodeCountry extends SAMLObject {
  ...
  String DEFAULT_ELEMENT_LOCAL_NAME = "NodeCountry";
  ...
  QName TYPE_NAME =
      new QName(EidasConstants.EIDAS_NS, TYPE_LOCAL_NAME, EidasConstants.EIDAS_PREFIX);
   ...
   * </p>
   *
   * @param nodeCountry the country code
   * @throws IllegalArgumentException if the {@code nodeCountry} parameter is not given in ISO 3166-1 alpha-2 format
   */
  void setNodeCountry(final String nodeCountry) throws IllegalArgumentException;
