 ...
 */
public class NationalityTypeImpl extends CountryStringTypeImpl implements NationalityType {
   ...
   */
  protected NationalityTypeImpl(@Nonnull final String namespaceURI, @Nonnull final String elementLocalName,
