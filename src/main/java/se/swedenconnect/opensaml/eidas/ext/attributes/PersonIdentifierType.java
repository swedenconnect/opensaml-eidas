 ...
 * <ol>
 * <li>The first part is the Nationality Code of the identifier. This is one of the ISO 3166-1 alpha-2 codes, followed
 * by a slash (“/“)).</li>
 * <li>The second part is the Nationality Code of the destination country or international organization. This is one of
 * the ISO 3166-1 alpha-2 codes, followed by a slash (“/“).</li>
 * <li>The third part a combination of readable characters. This uniquely identifies the identity asserted in the
 * country of origin but does not necessarily reveal any discernible correspondence with the subject's actual identifier
 * (for example, username, fiscal number etc).</li>
 * </ol>
 *
 * <p>
