...
public class RequestedAttributeTemplates {
   ...
   */
  public static RequestedAttribute PERSON_IDENTIFIER(final Boolean isRequired, final boolean includeFriendlyName) {
   ...
   */
  public static RequestedAttribute CURRENT_FAMILY_NAME(final Boolean isRequired, final boolean includeFriendlyName) {
   ...
   */
  public static RequestedAttribute CURRENT_GIVEN_NAME(final Boolean isRequired, final boolean includeFriendlyName) {
   ...
   */
  public static RequestedAttribute DATE_OF_BIRTH(final Boolean isRequired, final boolean includeFriendlyName) {
   ...
   */
  public static RequestedAttribute GENDER(final Boolean isRequired, final boolean includeFriendlyName) {
   ...
   */
  public static RequestedAttribute CURRENT_ADDRESS(final Boolean isRequired, final boolean includeFriendlyName) {
   ...
   */
  public static RequestedAttribute create(
      final String name, final String friendlyName, final String nameFormat, final Boolean isRequired) {
