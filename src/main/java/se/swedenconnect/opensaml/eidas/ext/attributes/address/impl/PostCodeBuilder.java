...
public class PostCodeBuilder extends AbstractXMLObjectBuilder<PostCode> {
  ...
  public PostCode buildObject() {
    return this.buildObject(EidasConstants.EIDAS_NP_NS, PostCode.DEFAULT_ELEMENT_LOCAL_NAME,
        EidasConstants.EIDAS_NP_PREFIX);
  }

  /** {@inheritDoc} */
  @Override
  public PostCode buildObject(final String namespaceURI, final String localName, final String namespacePrefix) {
