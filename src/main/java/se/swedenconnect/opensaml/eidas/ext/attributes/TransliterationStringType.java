...
public interface TransliterationStringType extends XSString, EidasAttributeValueType {
  ...
  String LATIN_SCRIPT_ATTRIB_NAME = "LatinScript";
   ...
   *
   * @param latinScript the {@code LatinScript} attribute value
   */
  void setLatinScript(final Boolean latinScript);
   ...
   * @param latinScript the {@code LatinScript} attribute value
   */
  void setLatinScript(final XSBooleanValue latinScript);
