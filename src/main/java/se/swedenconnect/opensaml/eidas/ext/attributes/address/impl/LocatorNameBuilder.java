...
public class LocatorNameBuilder extends AbstractXMLObjectBuilder<LocatorName> {
  ...
  public LocatorName buildObject() {
    return this.buildObject(EidasConstants.EIDAS_NP_NS, LocatorName.DEFAULT_ELEMENT_LOCAL_NAME,
        EidasConstants.EIDAS_NP_PREFIX);
  }

  /** {@inheritDoc} */
  @Override
  public LocatorName buildObject(final String namespaceURI, final String localName, final String namespacePrefix) {
