...
public class SchemeInformationImpl extends AbstractXMLObject implements SchemeInformation {
   ...
   */
  public SchemeInformationImpl(final String namespaceURI, final String elementLocalName, final String namespacePrefix) {
   ...
   */
  public void setIssuerName(final XSString issuerName) {
  ...
  /** {@inheritDoc} */
  @Override
  public void setSchemeIdentifier(final String schemeIdentifier) {
    XSURI uri = null;
   ...
   *
   * @param schemeIdentifier the scheme identifier
   */
  public void setSchemeIdentifier(final XSURI schemeIdentifier) {
  ...
  /** {@inheritDoc} */
  @Override
  public void setSchemeTerritory(final String schemeTerritory) {
    XSString st = null;
   ...
   *
   * @param schemeTerritory the scheme territory
   */
  public void setSchemeTerritory(final XSString schemeTerritory) {
